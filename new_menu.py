...
def register():
    ...
    if result != []:
        if not already_registered:
            login_menu.add.label(("User has already been registered, please log-in instead!"))
    ...
    for event in events:
        if event.type == pygame.QUIT:
            ...
            if not played_ai:
                ...
                board = Board()
                human_player = Player(1, (True if choices[3][0][1] == 1 else False), choices[1][0][1], "Player 1")
            ...
            if not played_2p:
                ...
                board = Board()
                player_one = Player(1, (True if choices[2][0][1] == 1 else False), choices[0][0][1], "Player 1")
                player_two = Player(2, (True if choices[2][0][1] == 2 else False), choices[1][0][1], "Player 2")
                board.PrintBoard()
