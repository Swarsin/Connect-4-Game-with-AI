    ...
    for event in events:
        if event.type == pygame.QUIT:
            ...
            if not played_ai:
                ...
                print(choices)
                board = Board()
                human_player = Player(1, (True if choices[3][0][1] == 1 else False), choices[1][0][1], "You")
            ...
            if not played_2p:
                ...
                print()
                board = Board()
                player_one = Player(1, (True if choices[2][0][1] == 1 else False), choices[0][0][1], p1_details[0])
                player_two = Player(2, (True if choices[2][0][1] == 2 else False), choices[1][0][1], p2_details[0])
                board.PrintBoard()
